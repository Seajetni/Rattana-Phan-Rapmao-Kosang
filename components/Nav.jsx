    ...
    <Disclosure as="nav" >
      {({ open }) => (
        <>
          ...
          <div className=" px-2 sm:px-6 lg:px-8 flex mr-10    justify-between xl:justify-center">
            ...
            <div className="relative flex h-16 items-center justify-center">
              <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
                {/* Mobile menu button*/}
                <Disclosure.Button className="relative inline-flex items-center justify-center rounded-md p-2 text-black hover:bg-[#5B5D12] hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
                ...
                <Disclosure.Button
                  ...
                  className={classNames(
                    item.current
                      ? " text-[#5B5D12]  "
                      : "text-[#5B5D12]   ",
                    "block rounded-md px-3 py-2 text-lg  hover:bg-white"
                  )}
                  aria-current={item.current ? "page" : undefined}
                >
                  {item.name}
